...
class Permisos extends BaseModel
{
    ...
    public function insertarPermisos(string $nombre, ?string $descripcion)
    {
        return $this->callProcedure('crear', [$nombre, $descripcion]);
    }

    public function editarPermisos(int $id, string $nombre, ?string $descripcion, bool $activo)
    {
        return $this->callProcedure('editar', [$id, $nombre, $descripcion, $activo]);
    }

    public function visualizarPermisos()
    {
        return $this->callProcedure('visualizar', []);
    }

    public function visualizarPermisoPorId(int $id)
    {
